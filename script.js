...
function addBigMessages() {
  ...
  '<a href="https://youtu.be/Es7nHl2Bb04">Why don\'t you put on some music to help you focus?</a>',
  ...
  'Why don\'t you read your journal entries?<br>Start from September 17, 2012.',
...
function randomLink(index,number) {
  ...
  if (message === "Get ready for church!")
    ...
    link.innerHTML = "<a href='../TakeABreak/breaktime.html'>Don't do nothing. Do something!</a> <strong onclick='rejectSomething(3)' style='color:white;'>No.</strong>";
    ...
    if (hydrate < 1)
      ...
      window.addEventListener("keyup", function (event) {
        if (event.keyCode === 77 && event.ctrlKey) {
          ...
          location.href = "https://youtu.be/Es7nHl2Bb04";
        }
      });
    }
  }
